...
#define PARSER_TABLE_NAME      System_Disk_Accessibility_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiSystemDiskAccessibilityOutput
...
int smSystem_Disk_Accessibility(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "System_Disk_Accessibility";
