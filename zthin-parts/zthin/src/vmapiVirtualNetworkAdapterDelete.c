...
#define PARSER_TABLE_NAME     Virtual_Network_Adapter_Delete_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkAdapterDeleteOutput
...
int smVirtual_Network_Adapter_Delete(
    ...
    const char * const functionName = "Virtual_Network_Adapter_Delete";
