...
#define PARSER_TABLE_NAME     Virtual_Network_Adapter_Delete_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkAdapterDeleteDmOutput

/**
 * Virtual_Network_Adapter_Delete_DM SMAPI interface
 */
int smVirtual_Network_Adapter_Delete_DM(
    ...
    const char * const functionName = "Virtual_Network_Adapter_Delete_DM";
