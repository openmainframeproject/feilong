...
#define PARSER_TABLE_NAME     Virtual_Network_Adapter_Create_Extended_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkAdapterCreateExtendedOutput

/**
 * Virtual_Network_Adapter_Create_Extended SMAPI interface
 */
int smVirtual_Network_Adapter_Create_Extended(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "Virtual_Network_Adapter_Create_Extended";
