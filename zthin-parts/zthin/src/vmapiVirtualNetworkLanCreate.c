...
#define PARSER_TABLE_NAME     Virtual_Network_LAN_Create_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkLanCreateOutput

/**
 * Virtual_Network_Lan_Create SMAPI interface
 */
int smVirtual_Network_LAN_Create(struct _vmApiInternalContext* vmapiContextP,
        char * userid, int passwordLength, char * password,
        char * targetIdentifier, char * lanName, char * lanOwner, char lanType,
        char transportType, vmApiVirtualNetworkLanCreateOutput ** outData) {
    const char * const functionName = "Virtual_Network_LAN_Create";
