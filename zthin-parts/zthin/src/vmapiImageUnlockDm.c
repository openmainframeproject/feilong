...
#define PARSER_TABLE_NAME     Image_Unlock_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageUnlockDmOutput

/**
 * Image_Unlock_DM SMAPI interface
 */
int smImage_Unlock_DM(struct _vmApiInternalContext* vmapiContextP,
        char * userid, int passwordLength, char * password,
        char * targetIdentifier, char * deviceAddress,
        vmApiImageUnlockDmOutput ** outData) {
    const char * const functionName = "Image_Unlock_DM";
