...
#define PARSER_TABLE_NAME     Static_Image_Changes_Deactivate_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiStaticImageChangesDeactivateDmOutput

/**
 * Static_Image_Changes_Deactivate_DM SMAPI interface
 */
int smStatic_Image_Changes_Deactivate_DM(
    ...
    const char * const functionName = "Static_Image_Changes_Deactivate_DM";
