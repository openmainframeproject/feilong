...
#define PARSER_TABLE_NAME      System_Performance_Threshold_Enable_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiSystemPerformanceThresholdEnableOutput
...
int smSystem_Performance_Threshold_Enable(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength,
    ...
    const char * const functionName = "System_Performance_Threshold_Enable";
