...
#define PARSER_TABLE_NAME     Virtual_Network_Adapter_Disconnect_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkAdapterDisconnectOutput

/**
 * Virtual_Network_Adapter_Disconnect SMAPI interface
 */
int smVirtual_Network_Adapter_Disconnect(
    ...
    const char * const functionName = "Virtual_Network_Adapter_Disconnect";
