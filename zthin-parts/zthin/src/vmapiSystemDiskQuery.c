...
#define PARSER_TABLE_NAME      System_Disk_Query_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiSystemDiskQueryOutput
...
int smSystem_Disk_Query(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "System_Disk_Query";
