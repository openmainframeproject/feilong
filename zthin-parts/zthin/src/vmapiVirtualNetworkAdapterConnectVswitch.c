...
#define PARSER_TABLE_NAME     Virtual_Network_Adapter_Connect_Vswitch_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkAdapterConnectVswitchOutput

/**
 * Virtual_Network_Adapter_Connect_Vswitch SMAPI interface
 */
int smVirtual_Network_Adapter_Connect_Vswitch(
    ...
    const char * const functionName = "Virtual_Network_Adapter_Connect_Vswitch";
