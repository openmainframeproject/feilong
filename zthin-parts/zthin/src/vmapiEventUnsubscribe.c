...
#define PARSER_TABLE_NAME     Event_Unsubscribe_Layout
#define OUTPUT_STRUCTURE_NAME vmApiEventUnsubscribeOutput

/**
 * Event_Unsubscribe SMAPI interface
 */
int smEvent_Unsubscribe(struct _vmApiInternalContext* vmapiContextP,
