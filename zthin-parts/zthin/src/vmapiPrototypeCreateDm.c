...
#define PARSER_TABLE_NAME     Prototype_Create_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiPrototypeCreateDmOutput

/**
 * Prototype_Create_DM SMAPI interface
 */
int smPrototype_Create_DM(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "Prototype_Create_DM";
