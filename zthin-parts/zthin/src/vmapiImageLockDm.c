...
#define PARSER_TABLE_NAME     Image_Lock_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageLockDmOutput

/**
 * Image_Lock_DM SMAPI interface
 */
int smImage_Lock_DM(struct _vmApiInternalContext* vmapiContextP, char * userid,
        int passwordLength, char * password, char * targetIdentifier,
        char * deviceAddress, vmApiImageLockDmOutput ** outData) {
    const char * const functionName = "Image_Lock_DM";
