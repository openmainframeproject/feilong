...
#define PARSER_TABLE_NAME     Virtual_Network_Vswitch_Set_Extended_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkVswitchSetExtendedOutput

/**
 * Virtual_Network_Vswitch_Set_Extended SMAPI interface
 */
int smVirtual_Network_Vswitch_Set_Extended(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength,
    ...
    const char * const functionName = "Virtual_Network_Vswitch_Set_Extended";
