...
#define PARSER_TABLE_NAME     System_Page_Utilization_Query_Layout
#define OUTPUT_STRUCTURE_NAME vmApiSystemPageUtilizationQueryOutput

/**
 * System_Page_Utilization_Query SMAPI interface
 */
...
int smSystem_Page_Utilization_Query(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength,
    ...
    const char * const functionName = "System_Page_Utilization_Query";
    int tempSize;
    char * cursor;
    int rc;
