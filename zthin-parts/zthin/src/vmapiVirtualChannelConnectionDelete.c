...
#define PARSER_TABLE_NAME     Virtual_Channel_Connection_Delete_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualChannelConnectionDeleteOutput

/**
 * Virtual_Channel_Connection_Delete SMAPI interface
 */
int smVirtual_Channel_Connection_Delete(
    ...
    const char * const functionName = "Virtual_Channel_Connection_Delete";
