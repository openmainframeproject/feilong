...
#define PARSER_TABLE_NAME     Virtual_Network_Adapter_Connect_LAN_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkAdapterConnectLanDmOutput

/**
 * Virtual_Network_Adapter_Connect_Lan_DM SMAPI interface
 */
int smVirtual_Network_Adapter_Connect_LAN_DM(
    ...
    const char * const functionName = "Virtual_Network_Adapter_Connect_LAN_DM";
