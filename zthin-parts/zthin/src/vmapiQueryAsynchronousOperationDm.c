...
#define PARSER_TABLE_NAME     Query_Asynchronous_Operation_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiQueryAsynchronousOperationDmOutput

/**
 * Query_Asynchronous_Operation_DM SMAPI interface
 */
int smQuery_Asychronous_Operation_DM(
    ...
    const char * const functionName = "Query_Asynchronous_Operation_DM";
    ...
    PUT_INT(operationId, cursor);  // Operation ID
