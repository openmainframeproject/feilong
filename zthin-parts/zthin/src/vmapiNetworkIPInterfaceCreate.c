...
#define PARSER_TABLE_NAME      Network_IP_Interface_Create_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiNetworkIPInterfaceCreateOutput
...
int smNetwork_IP_Interface_Create(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "Network_IP_Interface_Create";
