...
#define PARSER_TABLE_NAME      System_EQID_Query_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiSystemEQIDQueryOutput
...
int smSystem_EQID_Query(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "System_EQID_Query";
