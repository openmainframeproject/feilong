...
#define PARSER_TABLE_NAME     Static_Image_Changes_Activate_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiStaticImageChangesActivateDmOutput

/**
 * Static_Image_Changes_Activate_DM SMAPI interface
 */
int smStatic_Image_Changes_Activate_DM(
    ...
    const char * const functionName = "Static_Image_Changes_Activate_DM";
