...
#define PARSER_TABLE_NAME     Shared_Memory_Access_Add_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiSharedMemoryAccessAddDmOutput

/**
 * Shared_Memory_Access_Add_DM SMAPI interface
 */
int smShared_Memory_Access_Add_DM(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "Shared_Memory_Access_Add_DM";
