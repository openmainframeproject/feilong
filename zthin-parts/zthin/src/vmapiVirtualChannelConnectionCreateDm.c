...
#define PARSER_TABLE_NAME     Virtual_Channel_Connection_Create_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualChannelConnectionCreateDmOutput

/**
 * Virtual_Channel_Connection_Create_DM SMAPI interface
 */
int smVirtual_Channel_Connection_Create_DM(
    ...
    const char * const functionName = "Virtual_Channel_Connection_Create_DM";
