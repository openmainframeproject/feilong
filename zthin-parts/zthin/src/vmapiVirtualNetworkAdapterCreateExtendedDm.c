...
#define PARSER_TABLE_NAME     Virtual_Network_Adapter_Create_Extended_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkAdapterCreateExtendedDmOutput

/**
 * Virtual_Network_Adapter_Create_Extended_DM SMAPI interface
 */
int smVirtual_Network_Adapter_Create_Extended_DM(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength,
        char * password, char * targetIdentifier, int keyValueCount,
        char ** keyValueArray, vmApiVirtualNetworkAdapterCreateExtendedDmOutput ** outData) {
    int tempSize;
    int keyValueSize = 0;
    int i;
    int rc;
    ...
    const char * const functionName = "Virtual_Network_Adapter_Create_Extended_DM";
