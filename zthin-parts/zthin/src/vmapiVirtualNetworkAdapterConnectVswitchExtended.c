...
#define PARSER_TABLE_NAME     Virtual_Network_Adapter_Connect_Vswitch_Extended_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkAdapterConnectVswitchExtendedOutput
...
int smVirtual_Network_Adapter_Connect_Vswitch_Extended(struct _vmApiInternalContext* vmapiContextP, char * userid,
    ...
    const char * const functionName = "Virtual_Network_Adapter_Connect_Vswitch_Extended";
