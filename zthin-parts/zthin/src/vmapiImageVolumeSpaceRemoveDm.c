...
#define PARSER_TABLE_NAME     Image_Volume_Space_Remove_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageVolumeSpaceRemoveDmOutput

/**
 * Image_Volume_Space_Remove_DM SMAPI interface
 */
int smImage_Volume_Space_Remove_DM(struct _vmApiInternalContext* vmapiContextP,
        char * userid, int passwordLength, char * password,
        char * targetIdentifier, char functionType, char * regionName,
        char * imageVolumeId, char * groupName,
        vmApiImageVolumeSpaceRemoveDmOutput ** outData) {
    const char * const functionName = "Image_Volume_Space_Remove_DM";
