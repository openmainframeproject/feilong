...
#define PARSER_TABLE_NAME     Virtual_Network_Vswitch_Query_Byte_Stats_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkVswitchQueryByteStatsOutput

/**
 * Virtual_Network_Vswitch_Query_Byte_Stats SMAPI interface
 */
int smVirtual_Network_Vswitch_Query_Byte_Stats(
    ...
    const char * const functionName = "Virtual_Network_Vswitch_Query_Byte_Stats";
