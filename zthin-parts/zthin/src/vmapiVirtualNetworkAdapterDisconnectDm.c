...
#define PARSER_TABLE_NAME     Virtual_Network_Adapter_Disconnect_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkAdapterDisconnectDmOutput

/**
 * Virtual_Network_Adapter_Disconnect_DM SMAPI interface
 */
int smVirtual_Network_Adapter_Disconnect_DM(
    ...
    const char * const functionName = "Virtual_Network_Adapter_Disconnect_DM";
