...
#define PARSER_TABLE_NAME     Image_Lock_Query_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageLockQueryDmOutput

/**
 * Image_Lock_Query_DM SMAPI interface
 */
int smImage_Lock_Query_DM(struct _vmApiInternalContext* vmapiContextP,
    char * userid, int passwordLength, char * password,
    char * targetIdentifier, vmApiImageLockQueryDmOutput ** outData) {
    const char * const functionName = "Image_Lock_Query_DM";
