...
#define PARSER_TABLE_NAME     Name_List_Remove_Layout
#define OUTPUT_STRUCTURE_NAME vmApiNameListRemoveOutput

/**
 * Name_List_Remove SMAPI interface
 */
int smName_List_Remove(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "Name_List_Remove";
