...
#define PARSER_TABLE_NAME     Image_Definition_Create_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageDefinitionCreateDMOutput

/**
 * Image_Definition_Create_DM SMAPI interface
 */
int smImage_Definition_Create_DM(struct _vmApiInternalContext* vmapiContextP, char * userid,
    int passwordLength, char * password, char * targetIdentifier,  int keyValueCount,
    char ** keyValueArray, vmApiImageDefinitionCreateDMOutput ** outData) {

    const char * const functionName = "Image_Definition_Create_DM";
    int tempSize;
    int keyValueSize = 0;
    char * cursor;
    int i;
