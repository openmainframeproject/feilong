...
#define PARSER_TABLE_NAME      System_WWPN_Query_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiSystemWWPNQueryOutput
...
int smSystem_WWPN_Query(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "System_WWPN_Query";
