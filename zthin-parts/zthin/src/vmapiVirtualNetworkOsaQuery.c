...
#define PARSER_TABLE_NAME     Virtual_Network_OSA_Query_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkOsaQueryOutput
...
int smVirtual_Network_OSA_Query(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "Virtual_Network_OSA_Query";
