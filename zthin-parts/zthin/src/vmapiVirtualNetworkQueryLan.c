...
#define PARSER_TABLE_NAME     Virtual_Network_Query_LAN_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkQueryLanOutput

/**
 * Virtual_Network_Query_LAN SMAPI interface
 */
int smVirtual_Network_Query_LAN(struct _vmApiInternalContext* vmapiContextP, vmApiVirtualNetworkQueryLanOutput ** outData) {
    const char * const functionName = "Virtual_Network_Query_LAN";
