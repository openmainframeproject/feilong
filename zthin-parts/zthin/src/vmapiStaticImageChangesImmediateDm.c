...
#define PARSER_TABLE_NAME     Static_Image_Changes_Immediate_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiStaticImageChangesImmediateDmOutput

/**
 * Static_Image_Changes_Immediate_DM SMAPI interface
 */
int smStatic_Image_Changes_Immediate_DM(
    ...
    const char * const functionName = "Static_Image_Changes_Immediate_DM";
