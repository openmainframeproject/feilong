...
#define PARSER_TABLE_NAME     SMAPI_Status_Capture_Layout
#define OUTPUT_STRUCTURE_NAME vmApiSMAPIStatusCaptureOutput

/**
 * SMAPI_Status_Capture SMAPI interface
 */
int smSMAPI_Status_Capture(struct _vmApiInternalContext* vmapiContextP,
        char * userid, int passwordLength, char * password,
        char * targetIdentifier, vmApiSMAPIStatusCaptureOutput ** outData) {
    const char * const functionName = "SMAPI_Status_Capture";
