...
#define PARSER_TABLE_NAME     Image_Recycle_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageRecycleOutput

/**
 * Image_Recycle SMAPI interface
 */
int smImage_Recycle(struct _vmApiInternalContext* vmapiContextP, char * userid,
        int passwordLength, char * password, char * targetIdentifier,
        vmApiImageRecycleOutput ** outData) {
    const char * const functionName = "Image_Recycle";
