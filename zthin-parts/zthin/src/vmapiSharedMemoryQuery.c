...
#define PARSER_TABLE_NAME     Shared_Memory_Query_Layout
#define OUTPUT_STRUCTURE_NAME vmApiSharedMemoryQueryOutput

/**
 * Shared_Memory_Query SMAPI interface
 */
int smShared_Memory_Query(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "Shared_Memory_Query";
