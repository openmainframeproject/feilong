...
#define PARSER_TABLE_NAME     Image_IPL_Set_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageIplSetDmOutput

/**
 * Image_IPL_Set_DM SMAPI interface
 */
int smImage_IPL_Set_DM(struct _vmApiInternalContext* vmapiContextP,
        char * userid, int passwordLength, char * password,
        char * targetIdentifier, char * savedSystem, char * loadParameter,
        char * parameterString, vmApiImageIplSetDmOutput ** outData) {
    const char * const functionName = "Image_IPL_Set_DM";
