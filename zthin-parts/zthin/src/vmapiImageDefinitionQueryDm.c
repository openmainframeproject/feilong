...
#define PARSER_TABLE_NAME     Image_Definition_Query_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageDefinitionQueryDMOutput

/**
 * Image_Definition_Query_DM SMAPI interface
 */

int smImage_Definition_Query_DM(struct _vmApiInternalContext* vmapiContextP, char * userid,
        int passwordLength, char * password, char * targetIdentifier, char * keywordlist,
        vmApiImageDefinitionQueryDMOutput ** outData) {
    const char * const functionName = "Image_Definition_Query_DM";
    int tempSize;
    char * cursor;
    int rc;
