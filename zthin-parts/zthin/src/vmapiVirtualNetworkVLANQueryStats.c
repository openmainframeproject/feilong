...
#define PARSER_TABLE_NAME     Virtual_Network_VLAN_Query_Stats_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkVLANQueryStatsOutput
...
int smVirtual_Network_VLAN_Query_Stats(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength,
    ...
    const char * const functionName = "Virtual_Network_VLAN_Query_Stats";
