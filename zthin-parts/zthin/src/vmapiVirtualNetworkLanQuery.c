...
#define PARSER_TABLE_NAME     Virtual_Network_LAN_Query_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkLanQueryOutput

/**
 * Virtual_Network_Lan_Query SMAPI interface
 */
int smVirtual_Network_LAN_Query(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "Virtual_Network_LAN_Query";
