...
#define PARSER_TABLE_NAME     Shared_Memory_Delete_Layout
#define OUTPUT_STRUCTURE_NAME vmApiSharedMemoryDeleteOutput

/**
 * Shared_Memory_Delete SMAPI interface
 */
int smShared_Memory_Delete(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "Shared_Memory_Delete";
