...
#define PARSER_TABLE_NAME     Name_List_Destroy_Layout
#define OUTPUT_STRUCTURE_NAME vmApiNameListDestroyOutput

/**
 * Name_List_Destroy SMAPI interface
 */
int smName_List_Destroy(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "Name_List_Destroy";
