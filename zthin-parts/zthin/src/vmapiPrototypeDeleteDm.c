...
#define PARSER_TABLE_NAME     Prototype_Delete_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiPrototypeDeleteDmOutput

/**
 * Prototype_Delete_DM SMAPI interface
 */
int smPrototype_Delete_DM(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "Prototype_Delete_DM";
