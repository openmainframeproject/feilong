...
#define PARSER_TABLE_NAME     VMRM_Measurement_Query_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVmrmMeasurementQueryOutput

/**
 * VMRM_Measurement_Query SMAPI interface
 */
int smVMRM_Measurement_Query(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "VMRM_Measurement_Query";
