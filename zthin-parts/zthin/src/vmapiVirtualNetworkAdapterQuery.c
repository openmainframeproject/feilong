...
#define PARSER_TABLE_NAME     Virtual_Network_Adapter_Query_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkAdapterQueryOutput

/**
 * Virtual_Network_Adapter_Query SMAPI interface
 */
int smVirtual_Network_Adapter_Query(
    ...
    const char * const functionName = "Virtual_Network_Adapter_Query";
