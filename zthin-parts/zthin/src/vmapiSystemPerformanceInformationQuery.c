...
#define PARSER_TABLE_NAME     System_Performance_Information_Query_Layout
#define OUTPUT_STRUCTURE_NAME vmApiSystemPerformanceInformationQueryOutput

/**
 * System_Performance_Information_Query SMAPI interface
 */
...
int smSystem_Performance_Information_Query(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength,
        ...
        char ** keyValueArray, vmApiSystemPerformanceInformationQueryOutput ** outData) {
    const char * const functionName = "System_Performance_Information_Query";
    int tempSize;
    int keyValueSize = 0;
    char * cursor;
    int i;
