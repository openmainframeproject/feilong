...
#define PARSER_TABLE_NAME     Profile_Delete_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiProfileDeleteDmOutput

/**
 * Profile_Delete_DM SMAPI interface
 */
int smProfile_Delete_DM(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "Profile_Delete_DM";
