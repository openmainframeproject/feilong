...
#define PARSER_TABLE_NAME      VMRELOCATE_Status_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiVMRelocateStatusOutput

int smVMRELOCATE_Status(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
        char* targetIdentifier, int keyValueCount, char ** keyValueArray, vmApiVMRelocateStatusOutput** outData) {
    int tempSize;
    int keyValueSize = 0;
    int i;
    int rc;
    ...
    const char * const functionName = "VMRELOCATE_Status";
