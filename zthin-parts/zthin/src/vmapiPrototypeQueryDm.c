...
#define PARSER_TABLE_NAME     Prototype_Query_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiPrototypeQueryDmOutput

/**
 * Prototype_Query_DM SMAPI interface
 */
int smPrototype_Query_DM(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "Prototype_Query_DM";
