...
#define PARSER_TABLE_NAME     Shared_Memory_Access_Query_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiSharedMemoryAccessQueryDmOutput

/**
 * Shared_Memory_Access_Query_DM SMAPI interface
 */
int smShared_Memory_Access_Query_DM(
    ...
    const char * const functionName = "Shared_Memory_Access_Query_DM";
