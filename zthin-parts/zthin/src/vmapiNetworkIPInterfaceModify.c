...
#define PARSER_TABLE_NAME      Network_IP_Interface_Modify_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiNetworkIPInterfaceModifyOutput
...
int smNetwork_IP_Interface_Modify(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "Network_IP_Interface_Modify";
