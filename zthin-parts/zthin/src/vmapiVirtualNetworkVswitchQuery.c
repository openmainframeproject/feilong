...
#define PARSER_TABLE_NAME     Virtual_Network_Vswitch_Query_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkVswitchQueryOutput
...
int smVirtual_Network_Vswitch_Query(
    ...
    const char * const functionName = "Virtual_Network_Vswitch_Query";
