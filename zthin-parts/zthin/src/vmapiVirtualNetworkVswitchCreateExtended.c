...
#define PARSER_TABLE_NAME     Virtual_Network_Vswitch_Create_Extended_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkVswitchCreateExtendedOutput
...
int smVirtual_Network_Vswitch_Create_Extended(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength,
    ...
    const char * const functionName = "Virtual_Network_Vswitch_Create_Extended";
