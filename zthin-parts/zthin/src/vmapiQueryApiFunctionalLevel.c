...
#define PARSER_TABLE_NAME     Query_API_Functional_Level_Layout
#define OUTPUT_STRUCTURE_NAME vmApiQueryApiFunctionalLevelOutput

/**
 * Query_API_Functional_Level SMAPI interface
 */
int smQuery_API_Functional_Level(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "Query_API_Functional_Level";
