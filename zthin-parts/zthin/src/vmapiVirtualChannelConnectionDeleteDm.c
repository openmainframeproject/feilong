...
#define PARSER_TABLE_NAME     Virtual_Channel_Connection_Delete_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualChannelConnectionDeleteDmOutput

/**
 * Virtual_Channel_Connection_Delete_DM SMAPI interface
 */
int smVirtual_Channel_Connection_Delete_DM(
    ...
    const char * const functionName = "Virtual_Channel_Connection_Delete_DM";
