...
#define PARSER_TABLE_NAME     Image_IPL_Query_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageIplQueryDmOutput

/**
 * Image_IPL_Query_DM SMAPI interface
 */
int smImage_IPL_Query_DM(struct _vmApiInternalContext* vmapiContextP,
        char * userid, int passwordLength, char * password,
        char * targetIdentifier, vmApiImageIplQueryDmOutput ** outData) {
    const char * const functionName = "Image_IPL_Query_DM";
