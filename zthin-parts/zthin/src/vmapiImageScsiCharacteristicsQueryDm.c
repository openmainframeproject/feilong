...
#define PARSER_TABLE_NAME     Image_SCSI_Characteristics_Query_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageScsiCharacteristicsQueryDmOutput

/**
 * Image_SCSI_Characteristics_Query_DM SMAPI interface
 */
int smImage_SCSI_Characteristics_Query_DM(
        struct _vmApiInternalContext* vmapiContextP, char * userid,
        int passwordLength, char * password, char * targetIdentifier,
        vmApiImageScsiCharacteristicsQueryDmOutput ** outData) {
    const char * const functionName = "Image_SCSI_Characteristics_Query_DM";
