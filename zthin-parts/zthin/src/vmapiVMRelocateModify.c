...
#define PARSER_TABLE_NAME      VMRELOCATE_Modify_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiVMRelocateModifyOutput

int smVMRELOCATE_Modify(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
        char* targetIdentifier, int keyValueCount, char ** keyValueArray, vmApiVMRelocateModifyOutput** outData) {
    int tempSize;
    int keyValueSize = 0;
    int i;
    int rc;
    ...
    const char * const functionName = "VMRELOCATE_Modify";
