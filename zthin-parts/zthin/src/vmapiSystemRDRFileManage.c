...
#define PARSER_TABLE_NAME      System_RDR_File_Manage_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiSystemRDRFileManageOutput
...
int smSystem_RDR_File_Manage(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "System_RDR_File_Manage";
    ...
    PUT_INT(tempSize, cursor);  //Function Name
