...
#define PARSER_TABLE_NAME     Image_Definition_Delete_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageDefinitionDeleteDMOutput

/**
 * Image_Definition_Delete_DM SMAPI interface
 */
int smImage_Definition_Delete_DM(struct _vmApiInternalContext* vmapiContextP, char * userid,
    int passwordLength, char * password, char * targetIdentifier,  int keyValueCount,
    char ** keyValueArray, vmApiImageDefinitionDeleteDMOutput ** outData) {

    const char * const functionName = "Image_Definition_Delete_DM";
    int tempSize;
    int keyValueSize = 0;
    char * cursor;
    int i;
