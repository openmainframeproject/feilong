...
#define PARSER_TABLE_NAME      System_SCSI_Disk_Query_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiSystemSCSIDiskQueryOutput
...
int smSystem_SCSI_Disk_Query(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "System_SCSI_Disk_Query";
