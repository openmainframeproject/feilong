...
#define PARSER_TABLE_NAME     Name_List_Query_Layout
#define OUTPUT_STRUCTURE_NAME vmApiNameListQueryOutput

/**
 * Name_List_Query SMAPI interface
 */
int smName_List_Query(struct _vmApiInternalContext* vmapiContextP,
    ...
    const char * const functionName = "Name_List_Query";
