...
#define PARSER_TABLE_NAME     Query_Directory_Manager_Level_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiQueryDirectoryManagerLevelDmOutput

/**
 * Query_Directory_Manager_Level_DM SMAPI interface
 */
