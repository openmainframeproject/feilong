...
#define PARSER_TABLE_NAME     Response_Recovery_Layout
#define OUTPUT_STRUCTURE_NAME vmApiResponseRecoveryOutput

/**
 * Response_Recovery SMAPI interface
 */
int smResponse_Recovery(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "Response_Recovery";
    ...
    PUT_INT(failedRequestID, cursor);  // Failed RequestID
