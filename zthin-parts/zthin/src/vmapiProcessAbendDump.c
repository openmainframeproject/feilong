...
#define PARSER_TABLE_NAME      Process_ABEND_Dump_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiProcessAbendDumpOutput
...
int smProcess_ABEND_Dump(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "Process_ABEND_Dump";
