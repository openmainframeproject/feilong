...
#define PARSER_TABLE_NAME      System_FCP_Free_Query_Layout
#define OUTPUT_STRUCTURE_NAME  vmApiSystemFCPFreeQueryOutput
...
int smSystem_FCP_Free_Query(struct _vmApiInternalContext* vmapiContextP, char * userid, int passwordLength, char * password,
    ...
    const char * const functionName = "System_FCP_Free_Query";
