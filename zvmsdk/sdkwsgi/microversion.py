...
def raise_http_status_code_if_not_version(req, status_code, min_version,
    ...
    :param req: The HTTP request for the sdk api
    :param status_code: HTTP status code (integer value) to be raised
    :param min_version: Minimum sdk microversion level
    :param max_version: Maximum sdk microversion level
    :returns: None
...
def version_handler(min_ver, max_ver=None):
    ...
    Add as a decorator to a sdk API handler to constrain
