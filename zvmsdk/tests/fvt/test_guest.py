...
class GuestHandlerTestCase(GuestHandlerBase):
    ...
    def test_guest_create_with_profile_multiple_disks_with_vdev(self):
        ...
        self.assertFalse('MDISK 0100' in resp.content)
        self.assertFalse('MDISK 0101' in resp.content)
        self.assertTrue('MDISK 0200' in resp.content)
        self.assertTrue('MDISK 0300' in resp.content)
