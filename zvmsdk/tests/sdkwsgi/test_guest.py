...
class GuestHandlerTestCase(unittest.TestCase):
    ...
    def _make_transport_file(self):
        ...
        with open(transport_file, 'w') as f:
            f.write('{"admin_pass": "sMcTNh8b65dM", "random_seed": "", "uuid": "d93b1ef2-5ca7-459f-beaf-eedea6b6ee43", "availability_zone": "nova", "hostname": "deploy_tests", "launch_index": 0, "devices"    : [], "project_id": "6e3ab252b982424c859fa83ff281e8ab", "name": "transport_tests"}')
