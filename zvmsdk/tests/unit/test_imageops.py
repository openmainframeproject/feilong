...
class SDKImageOpsTestCase(base.SDKTestCase):
    ...
    @mock.patch.object(imageops.get_imageops()._smutclient, 'image_import')
    ...
    @mock.patch.object(imageops.get_imageops()._smutclient, 'image_query')
    ...
    @mock.patch.object(imageops.get_imageops()._smutclient, 'image_delete')
    ...
    @mock.patch.object(imageops.get_imageops()._smutclient, 'image_export')
