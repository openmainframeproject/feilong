...
class VolumeDbOperatorTestCase(base.SDKTestCase):
    ...
    def setUpClass(cls):
        ...
        # FIXME sqlite3.6 has a bug, in the same connection, create and then
        # drop a table, and then create it again, this second creation will
        # fail. The third time and forth will work well. So we need to create
        # it for third time here.
        cls._guest_util._create_guests_table()
