...
class SDKNetworkOpsTestCase(base.SDKTestCase):
    ...
    @mock.patch.object(zvmclient.XCATClient, 'update_port_definition')
    def test_update_port_definition(self, add_nic):
        self.networkops.update_port_definition("user_id", "port_id",
                                               "mac", "switch_name")
