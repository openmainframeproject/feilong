...
class HandlersHostTest(unittest.TestCase):
    ...
    @mock.patch.object(host.HostAction, 'get_power_state')
    def test_host_get_guest_power_state(self, mock_get, mock_userid):
        mock_get.return_value = ''
        mock_userid.return_value = FAKE_USERID

        host.host_get_guest_power_state(self.req)
