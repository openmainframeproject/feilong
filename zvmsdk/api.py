...
class SDKAPI(object):
    ...
    def guest_create(self, userid, vcpus, memory, disk_list=[],
        ...
        :param dict disk_list:
               a list of disks info for the guest, it contains one
               dictionary that contain some of the below keys for each disk,
               the root disk should be the first element in the list.
               {'size': str,
                'format': str,
                'is_boot_disk': bool,
                'disk_pool': str}
