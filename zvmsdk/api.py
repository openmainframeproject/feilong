...
class SDKAPI(object):
    ...
    def guest_create_network(self, userid, os_version,
                             gutst_networks, active=False):
        """ Create network for the guest

        :param str userid: the user id of the vm
        :param str os_version: operating system version of the guest
        :param list gutst_networks: a list of network info for the guest.
               It has one dictionary that contain some of the below keys for
        ...
        for network in gutst_networks:
            ...
            if (('gateway_addr' in network.keys()) and
                ...
                if not zvmutils.valid_IP(network['gateway_addr']):
