...
class SDKAPI(object):
    ...
    @check_input_types(_TSTR, _TSTR, _TUSERID, bool, bool)
    def guest_nic_couple_to_vswitch(self, vswitch_name, nic_vdev,
        ...
        :param bool active: whether make the change on active system
        ...
        if (not active) and (not persist):
            raise exception.ZVMInvalidInput(
                msg=('Need to specify how to couple nic to vswitch'))
    ...
    def guest_nic_uncouple_from_vswitch(self, vswitch_name, nic_vdev,
        ...
        if (not active) and (not persist):
            raise exception.ZVMInvalidInput(
                msg=('Need to specify how to uncouple nic to vswitch'))
