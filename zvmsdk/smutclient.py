...
#                   "https": HTTPSBackend
    ...
    def _get_active_memory_size(self, userid):
        ...
        try:
            ...
            standby_field = sizes[4].split(' ')[0]
            if standby_field != '0':
                active_standby = int(zvmutils.convert_to_mb(standby_field))
            else:
                active_standby = 0
            reserved_field = sizes[5]
            if reserved_field != '0':
                active_reserved = int(zvmutils.convert_to_mb(reserved_field))
            else:
                active_reserved = 0
        ...
        return (active_size, active_standby, active_reserved)
