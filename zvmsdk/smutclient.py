            ...
            try:
                ...
                try:
                    ...
                    if ((results['rc'] == 404) and
                        ...
                        persist_OK = False
                if persist_OK:
                    raise exception.SDKNetworkOperationError(rs=5,
                                    nic=vdev, userid=userid, err=msg1)
                else:
                        raise exception.SDKNetworkOperationError(rs=6,
                                    nic=vdev, userid=userid,
                                    create_err=msg1, couple_err=msg2)
                ...
                if ((results1 is not None) and
                    ...
                    if persist_OK:
                        raise exception.SDKNetworkOperationError(rs=3,
                                    nic=vdev, vswitch=vswitch_name, err=msg1)
                    else:
