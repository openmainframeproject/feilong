...
#                   "https": HTTPSBackend
    ...
    def live_resize_cpus(self, userid, start_addr, add_cnt):
        # start_addr is a hexadecimal value, the value should be in range 0-3F
        # Check cpu address in valid range
        def _cpu_addr_valid(self, addr):
        ...
        for offset in range(1, add_cnt):
            hex_addr = hex((decimal_start+offset), 16)[2:]
            hex_addrs.append(dec_addr)
