...
exported, the imported files will be put into /var/lib/zvmsdk/files/imported
the files to be exported will be put into /var/lib/zvmsdk/files/exported
    '''),
    # network options
    Opt('my_ip',
        section='network',
