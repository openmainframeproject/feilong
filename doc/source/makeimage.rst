...
.. code-block:: text
    ...
    >> conn.send_request('image_import', 'testimage', 'file:///root/testimage.img',
    {"os_version": "rhel6.7"},  remote_host="root@9.60.18.167")
    {u'rs': 10, u'overallRC': 300, u'modID': 40, u'rc': 300, u'output': u'',
     u'errmsg': u"Image import error: Copying image file from remote filesystem
     failed with error Warning: Permanently added '9.60.18.167' (ECDSA) to the
