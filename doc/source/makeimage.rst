...
or for convenience, you can use module ``requests``:

.. code-block:: text

    >> import requests
    >> import json
    >> url = 'http://1.2.3.4:8080/images'
    >> method = 'POST'
    >> headers = {'Content-Type': 'application/json', 'X-Auth-Token': '<your token>'}
    >> body = {'image': {"image_name": "0100", "url":"file:///var/lib/zvmsdk/images/0100", "remote_host": "root@6.7.8.9", "image_meta": {'os_version': 'rhel6.7'}}}
...
to specify the remote_host parameter in body. And please refer to :ref:`TokenUsage` to get
