...
1 Logon zVM cloud connector, and copy the following files to target vm
...
Where: auth_userid is the zVM cloud connector's userid, you may get the detail
...
3 Logon zVM cloud connector, run a simple command to check the if the iucv 
