/**
 * IBM (C) Copyright 2016 Apache License Version 2.0
...
#define PARSER_TABLE_NAME     Virtual_Network_Vswitch_Query_IUO_Stats_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkVswitchQueryIUOStatsOutput

/**
 * Virtual_Network_Vswitch_Query_IUO_Stats SMAPI interface
 */
int smVirtual_Network_Vswitch_Query_IUO_Stats(
    ...
    const char * const functionName = "Virtual_Network_Vswitch_Query_IUO_Stats";
