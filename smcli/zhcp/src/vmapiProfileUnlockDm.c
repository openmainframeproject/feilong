...
#define PARSER_TABLE_NAME     Profile_Unlock_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiProfileUnlockDmOutput

/**
 * Profile_Unlock_DM SMAPI interface
 */
int smProfile_Unlock_DM(struct _vmApiInternalContext* vmapiContextP,
        char * userid, int passwordLength, char * password,
        char * targetIdentifier, vmApiProfileUnlockDmOutput ** outData) {
    const char * const functionName = "Profile_Unlock_DM";
