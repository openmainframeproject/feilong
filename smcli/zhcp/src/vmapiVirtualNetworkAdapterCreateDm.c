...
#define PARSER_TABLE_NAME     Virtual_Network_Adapter_Create_DM_Layout
#define OUTPUT_STRUCTURE_NAME vmApiVirtualNetworkAdapterCreateDmOutput

/**
 * Virtual_Network_Adapter_Create_DM SMAPI interface
 */
int smVirtual_Network_Adapter_Create_DM(
    ...
    const char * const functionName = "Virtual_Network_Adapter_Create_DM";
