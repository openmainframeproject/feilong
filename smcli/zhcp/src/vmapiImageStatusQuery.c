...
#define PARSER_TABLE_NAME     Image_Status_Query_Layout
#define OUTPUT_STRUCTURE_NAME vmApiImageStatusQueryOutput

/**
 * Image_Status_Query SMAPI interface
 */
int smImage_Status_Query(struct _vmApiInternalContext* vmapiContextP,
        char * userid, int passwordLength, char * password,
        char * targetIdentifier, vmApiImageStatusQueryOutput ** outData) {
    const char * const functionName = "Image_Status_Query";
