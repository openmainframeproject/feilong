...
msg = {
    ...
    '0013': [{'overallRC': 4, 'rc': 4, 'rs': 13},
        "ULT%s0010E The desired state was not 'down', 'off', 'on' " +
        "or 'up': %s"],
    '0014': [{'overallRC': 4, 'rc': 4, 'rs': 14},
        "ULT%s0010E The desired state was not 'on' or 'up': %s"],
    ...
    '0402': [{'overallRC': 4, 'rc': 5, 'rs': 402},
            "ULT%s0402E No information was found for the specified pool(s): %s"],
