...
msg = {
    ...
    '0412': [{'overallRC': 4, 'rc': 4, 'rs': 412},     # dict is not used.
            "ULT%s0412E Unable to determine if guest is logged on, " +
            "cannot continue with query. RC from isLoggedOn %s"],
    '0413': [{'overallRC': 4, 'rc': 4, 'rs': 413},     # dict is not used.
            "ULT%s0413E Malformed reply from SMAPI, unable to fill " +
