...
msg = {
    ...
    '0400': [{'overallRC': 4, 'rc': 4, 'rs': 400},
        ...
        # SysAct: The command terminates without modifying the
        #   activation engine on the guest.
        # UserResp: Correct the command to point to an existing script
        #   and reissue the command.
    '0401': [{'overallRC': 4, 'rc': 7, 'rs': 401},
        ...
        #   reason.
        # SysAct:  Processing of the command ends with no action
        #   taken.
        # UserResp: Look up the reason the vmur command failed, correct
        #   the problem and reissue the SMUT command.
    '0402': [{'overallRC': 4, 'rc': 5, 'rs': 402},
        ...
        # SysAct: Query command returns with an error.
        # UserResp:  Correct the command to query existing pools and
        #   reissue the command.
    ...
    '0405': [{'overallRC': 4, 'rc': 6, 'rs': 405},
        ...
        #   not be queried.
        # SysAct: The getHost GENERAL command returns "no info" for
        #   the specified hypervisor information.
        # UserResp: If the information is needed, investigate the
        #   failure, correct it and reissue the SMUT command.
    '0406': [{'overallRC': 4, 'rc': 9, 'rs': 406},
        ...
        # SysAct:  Processing of the command ends with no action taken.
        # UserResp: This error could be because of another command
        #   also issuing vmur commands at the same time.  Wait a few
        #   seconds and reissue the SMUT command.
    ...
    '0408': [{'overallRC': 4, 'rc': 4, 'rs': 408},
        ...
        #   problem, then reissue the SMUT command.
    '0409': [{'overallRC': 4, 'rc': 4, 'rs': 409},
        ...
        #   would result in console output, then reissue the command.
    ...
    '0411': [{'overallRC': 4, 'rc': 4, 'rs': 411},
        ...
        #   address, update the SMUT code to recognize this, otherwise
        #   bring the reader at x'000C' online to Linux.
    ...
    '0418': [{'overallRC': 99, 'rc': 99, 'rs': 418},
        ...
        # SysAct:  Processing of the command ends with no action taken.
        # UserResp: Correct the syntax to specify a correct userid and
        #   reissue the command.
    '0419': [{'overallRC': 99, 'rc': 99, 'rs': 419},
        ...
        # SysAct:  Processing of the command ends with no action taken.
        # UserResp: Reissue the command for a relocation that is in
        #   progress.
    '0420': [{'overallRC': 99, 'rc': 99, 'rs': 420},     # dict is not used.
        ...
        #   correct the problems and reissue the SMUT command.
    ...
    '0422': [{'overallRC': 99, 'rc': 422, 'rs': 0},
        ...
        #   to processing the SMUT subfunction, so processing
        #   continues.
        # SysAct: Command processing continues.
        # UserResp: If there is reason to suspect the command did
