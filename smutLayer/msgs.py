...
msg = {
    ...
    '0316': [{'overallRC': 2, 'rc': 8},      # dict is not used.
            "ULT%s0316E On %s, command sent thru IUCV failed. " +
            "cmd: %s, rc: %s, rs: %s, out: %s"],
    ...
    '0319': [{'overallRC': 2},               # dict is not used.
            ...
            "while sending a command thru IUCV to $s. " +
            "cmd: %s, rc: %s, rs: %s, out: %s"],
