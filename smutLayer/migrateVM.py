...
def showInvLines( reqHandle ) :
    ...
    reqHandle.printLn( "N", "  python " + reqHandle.cmdName + " MigrateVM <userid> cancel" )
    reqHandle.printLn( "N", "  python " + reqHandle.cmdName + " MigrateVM help" )
    reqHandle.printLn( "N", "  python " + reqHandle.cmdName + " MigrateVM <userid> modify [ maxtotal <maxVal> ]" )
    reqHandle.printLn( "N", "                    [ maxquiesce <maxQVal> ]" )
    reqHandle.printLn( "N", "  python " + reqHandle.cmdName + " MigrateVM <userid> move destination <ssiMember>" )
    reqHandle.printLn( "N", "                    [ immediate ] [ forcearch ] [ forcedomain ] [ forcestorage ]" )
    reqHandle.printLn( "N", "                    [ maxtotal <maxVal> ] [ maxquiesce <maxQVal> ]" )
    reqHandle.printLn( "N", "  python " + reqHandle.cmdName + " MigrateVM <userid> status [ all | incoming | outgoing ]" )
    reqHandle.printLn( "N", "  python " + reqHandle.cmdName + " MigrateVM <userid> test destination <ssiMember>" )
    reqHandle.printLn( "N", "  python " + reqHandle.cmdName + " MigrateVM version" )
    return
