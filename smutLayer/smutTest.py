...
subs = {
    ...
    '<<<BigCfgFile>>>': '/install/zvm/POC/testImages/cfgdrive.tar',
                                        # Big tar file to test concurrent punch
...
vmModifyTests = [
    ...
    # To test concurrent vmur punch , run two punch test cases parallely
    {
        'description': "Punch the config drive tar file to the system" +
            " with an Big file.",
        'request': "ChangeVM <<<unsafeID1>>> punchfile <<<BigCfgFile>>>",
        'out': "",
        'overallRC': [0],
        'rc': [0],
        'rs': [0],
