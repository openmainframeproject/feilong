...
class SMUT(object):
    ...
    def __init__( self, **kwArgs ) :
        ...
        Input:
           cmdName=<Name of command> Specifies the name of the command that drives
                            SMUT.
    ...
    def disableLogCapture( self ) :
        ...
        self.captureLogs = False   # Don't capture Syslog entries for the client
    ...
    def request( self, requestData, **kwArgs ) :
        ...
        Input:
           ...
           requestId=<id> to pass a value for the request Id instead of using one
                          generated by SMUT.
        ...
        reqHandle = ReqHandle( requestId=requestId, captureLogs=logFlag, smut=self )

        reqHandle.parseCmdline( requestData )
        if reqHandle.results['overallRC'] == 0 :
            reqHandle.printSysLog( "Processing: " + reqHandle.requestString )
            reqHandle.driveFunction()

        return reqHandle.results
