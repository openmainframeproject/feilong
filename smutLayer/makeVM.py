...
def createVM(reqHandle):
    ...
    dirLines.append("USER " + reqHandle.userid + " " + reqHandle.parms['pw'] +
         " " + reqHandle.parms['priMemSize'] + " " +
         reqHandle.parms['maxMemSize'] + " " + reqHandle.parms['privClasses'])
    ...
    reqHandle.printSysLog("Exit makeVM.createVM, rc: " +
...
def doIt(reqHandle):
    ...
    if 'showParms' in reqHandle.parms and reqHandle.parms['showParms'] is True:
        ...
        reqHandle.printLn("N", "  Routine: makeVM." + 
