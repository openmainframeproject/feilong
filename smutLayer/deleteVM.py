...
subfuncHandler = {
                    'DIRECTORY'     : [ 'deleteMachine', lambda reqHandle: deleteMachine( reqHandle ) ],
...
def deleteMachine( reqHandle ):
    ...
    reqHandle.printSysLog( "Exit deleteVM.deleteMachine, rc: " + str( results['overallRC'] ) )
...
def doIt( reqHandle ):
    ...
    if 'showParms' in reqHandle.parms and reqHandle.parms['showParms'] == True :
        ...
        reqHandle.printLn( "N", "  Routine: deleteVM." + str( subfuncHandler[reqHandle.subfunction][0] ) + "( reqHandle )" )
...
def showInvLines( reqHandle ) :
    ...
    reqHandle.printLn( "N", "  python " + reqHandle.cmdName + " DeleteVM <userid> directory" )
    reqHandle.printLn( "N", "  python " + reqHandle.cmdName + " DeleteVM help" )
    reqHandle.printLn( "N", "  python " + reqHandle.cmdName + " DeleteVM version" )
    return
